...
# Heading
Label(root, text="Python Registration Form", font="arlal 15 bold").grid(row=0, column=3)
...
gengerentry =Entry(root, textvariable =gengervalue)
...
gengerentry.grid(row=3, column=3)
